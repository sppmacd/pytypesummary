...
class TestAnsi(TestCase):
    def test_enabled(self):
        ...
        self.assertTrue("\x1b[" in fo.format("TEEEST"))
    ...
    def test_disabled(self):
        ...
        self.assertFalse("\x1b[" in fo.format("TEEEST"))
...
class TestStr(TestCase):
    def test(self):
        ...
        self.assertEqual(formatter.format("12345612345612345"), '"12345612345612345"')
        self.assertEqual(formatter.format("123456123456123456"), '"123456123456123456"')
        self.assertEqual(
...
class TestIterable(TestCase):
    def test_list(self):
        self.assertEqual(formatter.format([1, 2.0, 3]), "list[1, 2.0, 3]")
        self.assertEqual(formatter.format([1, 2, "test", 4]), 'list[1, 2, "test", 4]')
        self.assertEqual(
    ...
    def test_range(self):
        self.assertEqual(formatter.format(range(100)), "range(0, 100)")
